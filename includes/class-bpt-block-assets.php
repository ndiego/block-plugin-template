 ...
 * @since 1.0.0
 */
class BlockPluginTemplate_Block_Assets {


	/**
	 * This class's instance.
	 *
	 * @var BlockPluginTemplate_Block_Assets
	 */
	...
	public static function register() {
		if ( null === self::$instance ) {
			self::$instance = new BlockPluginTemplate_Block_Assets();
		}
	}
	...
	public function get_asset_file( $filepath ) {
		$asset_path = BPT_PLUGIN_DIR . $filepath . '.asset.php';
...
BlockPluginTemplate_Block_Assets::register();
